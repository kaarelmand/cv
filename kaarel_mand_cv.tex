...
\\[0.1cm]
\begin{minipage}[t]{0.7\textwidth}
    Email: \faEnvelope\ \href{mailto:\Email}{\Email}
    \\
    ORCID: \aiOrcid\ \href{https://orcid.org/\ORCID}{\ORCID}
    \\
    Website: \faDesktop\ \Website{\PersonalWebsite}
    \\
    Google Scholar: \aiGoogleScholar\ \Website{scholar.google.com/citations?user=srxWszgAAAAJ}
    \\
    ETIS: \Website{\ETIS}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
